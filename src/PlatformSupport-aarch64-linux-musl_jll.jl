module PlatformSupport-aarch64-linux-musl_jll
...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import PlatformSupport-aarch64-linux-musl_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("c682c9d1-dff2-5b31-9a19-0dd5979e460d"))
platforms = [Pkg.Artifacts.unpack_platform(e, "PlatformSupport-aarch64-linux-musl", artifacts_toml) for e in artifacts["PlatformSupport-aarch64-linux-musl"]]
...
if best_platform === nothing
    @debug("Unable to load PlatformSupport-aarch64-linux-musl; unsupported platform $(triplet(platform_key_abi()))")
else
    # Load the appropriate wrapper
    include(joinpath(@__DIR__, "wrappers", "$(best_platform).jl"))
end

end  # module PlatformSupport-aarch64-linux-musl_jll
